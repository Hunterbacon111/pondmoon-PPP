#!/bin/bash
# Ancora - One-click deploy: upload data → build on server → dashboard updated
set -e

SERVER="root@159.65.35.217"
REMOTE_DIR="/var/www/dashboards/Ancora"
LOCAL_DIR="$(cd "$(dirname "$0")" && pwd)"

echo "============================================"
echo "  Ancora - Deploy to Server"
echo "============================================"
...
scp -r "$LOCAL_DIR/Data_Loan" "$SERVER:$REMOTE_DIR/"
...
echo ""
echo "============================================"
echo "  Done! Visit: http://159.65.35.217/ancora/"
echo "============================================"
